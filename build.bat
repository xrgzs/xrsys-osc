...
curl.exe -sSL https://file.uhsea.com/2403/5b5716e6373e21f2a4c3ed211cecb9f1SI.exe -o osc\apifiles\DriveCleaner.exe || exit
...
rem MSVC Runtime repacked by Xiaoran Studio using NSIS v14.40.33721.2
curl.exe -sSL https://file.uhsea.com/2403/6843abb0a14c4386d961e43baf7f2589CL.exe -o osc\runtime\MSVCRedist.AIO.exe || exit
